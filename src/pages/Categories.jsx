...
function Categories(){
    ...
    return(
        <>
            ...
            <TablePagination count={categoryRecords?.totalItems} rowsPerPageOptions={recordsPerpage} rowsPerPage={filters.pageSize || 0} page={filters.pageIndex - 1} onPageChange={(e, newPage) => {setFilters({...filters, pageIndex: newPage + 1});}} onRowsPerPageChange={(e) => {setFilters({...filters, pageIndex: 1, pageSize: Number(e.target.value),});}} />
